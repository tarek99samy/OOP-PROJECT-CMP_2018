...
public:
	...
	void DrawRhombus(Point P1 , GfxInfo RoGfxInfo, bool selected=false) const;  //Draw a Rhombous
	void DrawTriangle(Point P1, Point P2,Point P3, GfxInfo RectGfxInfo, bool selected=false) const;  //Draw a triangle
	void DrawEllipse(Point P1, GfxInfo RectGfxInfo, bool selected=false) const;
